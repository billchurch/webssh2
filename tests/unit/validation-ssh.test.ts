...
void describe('SSH Validation Functions', () => {
  void describe('validateHost', () => {
    void it('should return IP addresses unchanged', () => {
    ...
    void it('should escape non-IP hostnames', () => {
  ...
  void describe('validatePort', () => {
    void it('should accept valid port numbers', () => {
    ...
    void it('should return default for invalid ports', () => {
  ...
  void describe('validateTerm', () => {
    void it('should accept valid terminal types', () => {
    ...
    void it('should reject invalid terminal types', () => {
  ...
  void describe('validatePrivateKey', () => {
    void it('should accept valid private key formats', () => {
...
-----END EC PRIVATE KEY-----`
    ...
    void it('should reject invalid private keys', () => {
  ...
  void describe('isEncryptedKey', () => {
    void it('should detect encrypted keys', () => {
...
b3BlbnNzaC1rZXktdjEAAAAACmFlczI1Ni1jdHIAAAAGYmNyeXB0AAAAGAAAABBB`
    ...
    void it('should detect unencrypted keys', () => {
...
MIIEpAIBAAKCAQEA0Z3VS5JJcds3xfn/ygWyF0qnMDvtaE68iS8RwZTyT8TsLHYr`
  ...
  void describe('normalizeDimension', () => {
    void it('should prefer provided value when valid', () => {
    ...
    void it('should use session value when provided value invalid', () => {
    ...
    void it('should use default when both values invalid', () => {
