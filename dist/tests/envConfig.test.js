...
describe('Environment Configuration Tests', () => {
  ...
  test('loadEnvironmentConfig handles JSON array format', () => {
    process.env.WEBSSH2_SSH_ALGORITHMS_CIPHER =
      '["aes256-gcm@openssh.com","aes128-ctr","aes256-ctr"]'
    process.env.WEBSSH2_HTTP_ORIGINS = '["https://example.com","https://api.example.com"]'
    const config = loadEnvironmentConfig()
    assert.deepEqual(config.ssh.algorithms.cipher, [
